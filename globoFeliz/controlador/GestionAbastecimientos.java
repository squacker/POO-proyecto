...
public class GestionAbastecimientos {
...
// ATRIBUTOS
	...
	private ArrayListAbastecimiento abastecimientos = new ArrayListAbastecimiento(abastecimiento); // MODELO

	private IGUAbastecimiento interfaz = new IGUVentas(); // VISTA
		...
		do {
			...
			switch (opcion) {
				...
				case 1: // AGREGAR (CREATE)
					...
					abastecimientoNuevo = new A (" ", interfaz.leerIdProductosVendidos(), " ", " ", 0.0f);
