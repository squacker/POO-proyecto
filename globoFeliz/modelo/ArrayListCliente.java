...
// METODOS (CRUD)
    ...
    public boolean modificarCliente(String id, int opcion, String modificaCadena, int modificaEdad, String modificaTelefono) {
        if (listaClientes.size() <= 0) {
            return false;
        } else {
            int posicion = buscarCliente(id);
            if (posicion == -1) {
                ...
                switch (opcion) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        clienteModificado.setTelefonoCliente(modificaTelefono);
                        break;
                    default:
                        break;
                }
